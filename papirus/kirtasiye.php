        ...
        $(document).ready(function() {
            ...
            $('.addToCartBtn').click(function(event) {
                ...
                $.ajax({
                    url: 'sepet_db.php',
                    method: 'POST',
                    data: { p: 'addToCart', urun_id: productId, category: 'ürünlistesi' },
                    success: function(response) {
                        updateCartCount();
                    }
                });
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <small style="font-size: 20px;" class="text-muted"><?php echo $ürün['fiyat']; ?>₺</small>
                            </div>
                            <div class="btn-group">
                                <button data-product-id="<?php echo $ürün['id']; ?>" role="button" class="button addToCartBtn">Sepete ekle</button>
                            </div>
                        </div>
                    </div>
                     <?php } ?>
