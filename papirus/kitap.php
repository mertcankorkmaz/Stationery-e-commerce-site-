...
$kitaplistesi = mysqli_fetch_all($result, MYSQLI_ASSOC);
session_start();
        ...
        $(document).ready(function() {
            ...
            $('.addToCartBtn').click(function(event) {
                ...
                $.ajax({
                    url: 'sepet_db.php',
                    method: 'POST',
                    data: { p: 'addToCart', urun_id: productId, category: 'kitaplar' },
                    success: function(response) {
                        updateCartCount();
                    }
                });
...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="kitap.php">Kitap</a>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-12">
                <div class="row">
                    <?php foreach ($kitaplistesi as $kitap) { ?>
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <small style="font-size: 20px;" class="text-muted"><?php echo $kitap['fiyat']; ?>₺</small>
                            </div>
                            <div class="btn-group">
                                <button data-product-id="<?php echo $kitap['id']; ?>" role="button" class="button addToCartBtn">Sepete ekle</button>
                            </div>
                        </div>
                    </div>
                     <?php } ?>
